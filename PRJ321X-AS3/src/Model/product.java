...
public class product {
	...
	public product(int product_id, String product_name, String product_des, float product_price,
			String product_img_source, String product_type, String product_brand) {
		super();
	...
	public product(int product_id, String product_name, String product_des, float product_price,
			String product_img_source, String product_type, String product_brand,int amoun) {
		super();
		this.product_id = product_id;
		this.product_name = product_name;
		this.product_des = product_des;
	...
	public product(int product_id, String product_name, float product_price,
			String product_img_source,int amoun) {
		super();
		this.product_id = product_id;
		this.product_name = product_name;
		this.product_price = product_price;
